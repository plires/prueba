...
<html class="no-js" lang="es-AR" dir="ltr">
  ...
  <body>
    <?php include_once("../includes/analyticstracking.php"); /*Google Analitycs*/ ?>
    <!-- Google Code for Landing Pivotantes Conversion Page -->
    <script type="text/javascript">
    /* <![CDATA[ */
    var google_conversion_id = 876263839;
    var google_conversion_language = "en";
    var google_conversion_format = "3";
    var google_conversion_color = "ffffff";
    var google_conversion_label = "lhyTCIjw-2kQn_PqoQM";
    ...
    <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/876263839/?label=lhyTCIjw-2kQn_PqoQM&amp;guid=ON&amp;script=0"/>
    </div>
    </noscript>
    ...
    <div class="row foto_mobile">
      <div class="small-12 columns centrar">
        <img src="img/pivotantes-2.jpg" alt="portones pivotantes">
        <h1>Envio Exitoso!</h1>
          <p>Gracias por tu envio.</p><br>
          <p>En breve nos estaremos contactando para contestar todas tus consultas.</p>
      </div>
    </div>
    ...
    <div class="foto_fondo">
      <div class="row">
        ...
        <div class="small-12 columns datos-gracias callout">
          <h1 class="h1_gracias">Envio Exitoso!</h1>
          <p>Gracias por tu envio.</p><br>
          <p>En breve nos estaremos contactando para contestar todas tus consultas.</p>
        </div>
